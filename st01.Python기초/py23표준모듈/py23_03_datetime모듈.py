...
print(now)  # 2020-03-08 16:23:13.950191
print(now.year)
print(now.month)
print(now.day)
print(now.hour)
...
########################
# 계절을 확인합니다. now.month를 이용
month = now.month

# 현재 날짜/시간을 구하고 월을 변수에 저장합니다.
# 조건문으로 계절을 확인합니다.
# 예시) 현재는 봄입니다.
# date 출력 함수 만들기. 예시) 2020-03-02 16:45:06
def dateFormat(tm):
    print(tm)
...
print("datetime.replace()로 시간더하기 >> 1년 1주 더하기")
